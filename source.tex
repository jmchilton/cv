...
Pratik Jagtap,  Sricharan Bandhakavi,  LeeAnn Higgins, Thomas McGowan,  Rongxiao Sa,  Matthew Stone, John Chilton, Edgar Arriaga, Sean Seymour and Tim Griffin. Workflow for analysis of high mass accuracy salivary dataset using MaxQuant and ProteinPilot search algorithm. Proteomics (Accepted for publication in Proteomics).
